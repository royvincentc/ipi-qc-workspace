...
import {ArrowUpRight,FlaskConical,Search,LoaderCircle} from 'lucide-react';
...
export function Loading(){return <div className="empty"><LoaderCircle className="spin"/>Loading workspace…</div>;}
